...
export const DAILY_GOSPEL_DB: Record<string, Verse> = {
  ...
  "2026-03-15": { id: 20260315, text: "주님이 말씀하신다. 나는 세상의 빛이다. 나를 따르는 이는 생명의 빛을 얻으리라.", reference: "요한 8,12 ", category: "복음 환호성" },
  "2026-03-16": { id: 20260316, text: "너희는 악이 아니라 선을 찾아라. 그래야 살리라. 그래야 주님이 너희와 함께 있으리라..", reference: "아모 5,14", category: "복음 환호성" },
  "2026-03-17": { id: 20260317, text: "하느님, 제 마음을 깨끗이 만드시고 구원의 기쁨을 제게 돌려주소서..", reference: "시편 51(50),12.14 ", category: "복음 환호성" },
  "2026-03-18": { id: 20260318, text: "주님이 말씀하신다. 나는 부활이요 생명이다. 나를 믿는 사람은 영원히 죽지 않으리라.", reference: "요한 11,25.26", category: "복음 환호성" },
  "2026-03-19": { id: 20260319, text: "주님, 행복하옵니다, 당신 집에 사는 이들! 그들은 영원토록 당신을 찬양하리이다.", reference: "시편 84(83),5 ", category: "복음 환호성" },
  "2026-03-20": { id: 20260320, text: "사람은 빵만으로 살지 않고 하느님의 입에서 나오는 모든 말씀으로 산다.", reference: "마태 4,4", category: "복음 환호성" },
  "2026-03-21": { id: 20260321, text: "바르고 착한 마음으로 하느님 말씀을 간직하여 인내로 열매를 맺는 사람들은 행복하여라!", reference: "루카 8,15", category: "복음 환호성" } //사순 제5주일
};
